...
##########      #       #       ##########      #           #
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFACEBOOK : ARYAN UPRETI 
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mFB GROUP : UNKNOWN  
\033[1;91m [\033[1;94m✯\033[1;91m] \033[1;92mGITHUB   : EREN HACKER
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  \n")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://www.facebook.com/aryan.upreti.5836 ")
		exit(" [*] GitHub    : https://github.com/Erenhacker")
	else:
		Main()
